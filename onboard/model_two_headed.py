...
class Model:
    ...
    def __init__(self):
        ...
        self.out_speed_tensor_idx = self.interpreter.get_output_details()[1]["index"]
    ...
    def predict(self, img):
        ...
        pred_speed = self.interpreter.get_tensor(self.out_speed_tensor_idx).squeeze()
        print(pred_angle)
        print(pred_speed)

        angle, speed = (clip(pred_angle, 0, 1), clip(pred_speed, 0, 1))
        speed = rint(speed)
